## 📊 Power BI Dashboards: Blinkit Grocery & Performance Tracker
...
-> Customer Behavior: Most frequent orders occur during late evenings.
...
2.Connect to the provided .xlsx datasets when prompted.
